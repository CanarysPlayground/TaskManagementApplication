...
Development Team
Client / Audience (for Copilot demo)

3. In Scope

Task creation and management
Client-side persistence
Simple UI with filtering
Demonstration of Copilot-assisted development
...
Complex workflows or roles

5. Business Requirements
BR 01: Task Management
The system shall allow users to create, update, delete, and view tasks.
BR 02: Task Status Tracking
The system shall allow users to mark tasks as completed or pending.
BR 03: Task Prioritization
The system shall allow users to assign and view task priority levels.
BR 04: Task Filtering
The system shall allow users to filter tasks by status and priority.
BR 05: Data Persistence
The system shall retain tasks after page refresh using local storage.
...
Codebase is understandable and extensible
